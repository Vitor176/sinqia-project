    ...
    class Program
    {
        ...
        static void EstruturaVetoresMatrizes() {           
            ...
            */
            ...
            // Criamos uma matriz bidimensional, utilizamos a virgula quando queremos declarar ela como bi
            string [,] AlunosLC = new string[6,2]; // 6 -> linhas ; 2 -> colunas
            ...
            /* Entra em um laço de repetição onde, i começa com 0; enquanto i for menor ou igual a
            quantidade de elementos na dimensao 0
            */
            // dimensão 0 quantidade de elementos == 5;
            
            for(int i = 0; i <= AlunosLC.GetUpperBound(0); i++) {
                // dimensao 1 quantidade de elementos == 1
