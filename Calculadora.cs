...
namespace Sinqia_Projeto_Modulo01
{
    class Calculadora {
        ...
        public void SelectOption(int opcao) {
            ...
            {
                case 1:
                    Console.WriteLine($"A soma dos dois valores é: { NumberOne + NumberTwo}\n");
                    menu.MenuCalc();
                    break;
                case 2:
                    Console.WriteLine($"A multiplicação dos dois valores é: { NumberOne * NumberTwo}\n");
                    menu.MenuCalc();
                    break;
                case 3:
                    Console.WriteLine($"A divisão dos dois valores é: {NumberOne / NumberTwo}\n");
                    menu.MenuCalc();
                    break;
                case 4:
                    Console.WriteLine($"A subtração dos dois valores é: {NumberOne - NumberTwo}\n");
                    menu.MenuCalc();
                    break;
                case 5:
                    Console.WriteLine($"A resto da divisão dos dois valores é: {NumberOne % NumberTwo}\n");
                    menu.MenuCalc();
                    break;                    
                case 6:                    
                    Environment.Exit(0);
